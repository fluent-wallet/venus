...
export function createSignature(params: SignatureParams, prepareCreate: true): Signature;
export function createSignature(params: SignatureParams): Promise<Signature>;
