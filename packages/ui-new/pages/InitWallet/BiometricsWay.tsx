...
const BiometricsWay: React.FC<{ navigation: StackScreenProps<typeof WelcomeStackName> }> = ({ navigation }) => {
  const { mode, colors } = useTheme();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={[styles.first, { color: colors.textFifth, backgroundColor: colors.bgThird }]}>Biometrics Way</Text>
    </SafeAreaView>
  );
};
