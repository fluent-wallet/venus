...
const GasFeeSetting: React.FC<Props> = ({ show, tx, onClose, onConfirm, dappCustomizeGasSetting, dappCustomizeAdvanceSetting, force155 }) => {
  ...
  const [customizeAdvanceSetting, setCustomizeAdvanceSetting] = useState<AdvanceSetting | null>(() => (dappCustomizeAdvanceSetting as AdvanceSetting) ?? null);
  ...
  const handleConfirm = useCallback(() => {
    if (tempSelectedOptionLevel === null || !estimateRes || !estimateGasSettings) return;
