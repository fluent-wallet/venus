    ...
    >
      <View className="flex flex-row p-3 items-center border rounded-lg mb-4" style={{ borderColor: theme.colors.warnErrorPrimary }}>
        ...
        <View className="flex-1 ml-2">
          <Text className="text-sm font-normal leading-6" style={{ color: theme.colors.warnErrorPrimary }}>
      ...
      <View style={{ backgroundColor: theme.colors.surfaceCard }} className="p-[15px] rounded-md">
        <Text className="text-base font-normal leading-6" style={{ color: theme.colors.textSecondary }}>
          From
        </Text>
        ...
        <Text className="ml-8 text-base font-normal leading-6" style={{ color: theme.colors.textSecondary }}>
          Balance: 100,000 CFX
        </Text>
      ...
      <View style={{ backgroundColor: theme.colors.surfaceCard }} className="p-[15px] rounded-md">
        <View className="flex flex-row justify-between">
          ...
          <View className="flex">
            ...
            <Text style={{ color: theme.colors.textSecondary }} className="text-right text-sm font-normal leading-6">
              ≈$99.00
            </Text>
          </View>
        </View>
        ...
        <View className="flex flex-row justify-between">
          ...
          <Text className="text-base font-normal leading-6">Conflux eSpace</Text>
        </View>
      </View>
