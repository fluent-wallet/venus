...
export const SendStackName = 'Send';
...
const Send: React.FC<{ navigation: StackNavigation }> = ({ navigation }) => {
    ...
    >
      <KeyboardAvoidingView behavior="padding" className="flex-1">
        ...
        <View className="mt-[13px]">
          ...
          <View style={{ backgroundColor: theme.colors.surfaceCard }} className="rounded-md p-4">
